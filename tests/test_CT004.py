...
class TestCT003:
    def testtransferfailed(self, open_browser):
        ...
        transfer_p.select_to_account('800000 Corporate')
        transfer_p.fill_amount_to_transfer('200')
        transfer_p.click_to_transfer()
        assert transfer_p.failed_transferred_message_displayed(login_p.driver), 'Message not displayed!'
